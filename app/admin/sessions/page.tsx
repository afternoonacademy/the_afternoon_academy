        ...
        return <Card className="overflow-hidden" key={tableNumber}>
          ...
          <CardContent className="space-y-4 p-3 sm:p-4">
            {session ? <form action={saveSessionDateOverride} className="grid gap-2 rounded-lg border bg-muted/20 p-3 sm:grid-cols-2">
              ...
              <div className="flex gap-2 sm:col-span-2"><Button className="min-h-10" size="sm">Save this date</Button>{dateOverride ? <form action={restoreSessionWeeklyDefault}><input name="sessionId" type="hidden" value={session.id} /><input name="serviceDate" type="hidden" value={selectedDate} /><Button className="min-h-10" size="sm" type="submit" variant="outline">Restore weekly default</Button></form> : null}</div>
            </form> : null}
